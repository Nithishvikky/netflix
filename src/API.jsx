export const homeData = [
	{
	  ...
	  rating: 6.1,
	  time: "2hr : 22mins",
	  desc: "A major bank heist takes an unnerving turn when a mysterious interloper known only as Dark Devil begins to hijack thee operation.",
	  starring: "Ajith Kumar, Manju Warrier",
	  genres: "Action",
	  tags: "Action, Military Movies, Voilence",
	  cover: "../images/ajith.jpg",
	...
	},
	{
	  ...
	  rating: 5.2,
	  time: "2hr : 36mins",
	  desc: "A jaded former intelligence agent is pulled back into action when an attack at a mall creates a tense hostage situation",
	  starring: "Vijay, Pooja Hegde",
	  genres: "Action",
	  tags: "Action, Military Movies, Voilence",
	  cover: "../images/home4.avif",
